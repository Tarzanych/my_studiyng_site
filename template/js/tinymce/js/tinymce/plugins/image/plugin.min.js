tinymce.PluginManager.add("image", function(t) {
  ...
  function i(n) {
    ...
    function o() {
      ...
      var n = s.toJSON();
      "" === n.width && (n.width = null), "" === n.height && (n.height = null), "" === n.style && (n.style = null), n = {src: n.src, alt: n.alt, width: n.width, height: n.height, style: n.style}, t.undoManager.transact(function() {
    ...
    d = m.getAttrib(p, "width"), u = m.getAttrib(p, "height"), "IMG" != p.nodeName || p.getAttribute("data-mce-object") ? p = null : g = {src: m.getAttrib(p, "src"), alt: m.getAttrib(p, "alt"), width: d, height: u}, n && (h = {type: "listbox", label: "Image list", values: i(), value: g.src && t.convertURL(g.src, "src"), onselect: function(t) {
        var e = s.find("#alt");
