tinymce.PluginManager.add("insertdatetime", function(e) {
  ...
  function n(n) {
    ...
    if (e.settings.insertdatetime_element) {
      var i;
      i = /%[HMSIp]/.test(n) ? t("%Y-%m-%dT%H:%M") : t("%Y-%m-%d"), r = '<time datetime="' + i + '">' + r + "</time>";
      var o = e.dom.getParent(e.selection.getStart(), "time");
      if (o)
        return e.dom.setOuterHTML(o, r), void 0
    }
    e.insertContent(r)
  }
  var r, i = "Sun Mon Tue Wed Thu Fri Sat Sun".split(" "), o = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" "), a = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), s = "January February March April May June July August September October November December".split(" "), l = [];
