  ...
  r(l, [c, d, u], function(e, t, n) {
    ...
    function i(r) {
      function i(e) {
        ...
        if (l[t] && (s += " "), c[t])
          return s += " ", void 0;
        if (3 == e.type && (s += e.value), !e.shortEnded && (e = e.firstChild))
          do
            i(e);
          while (e = e.next);
        d[t] && n.next && (s += "\n", "p" == t && (s += "\n"))
    ...
    return function(r) {
      function i(e) {
        var t, n = r.dom;
        if (r.settings.paste_data_images || (e = e.replace(/<img[^>]+src=\"data:image[^>]+>/g, "")), t = r.fire("BeforePastePreProcess", {content: e}), t = r.fire("PastePreProcess", t), e = t.content, !t.isDefaultPrevented()) {
      ...
      function a() {
        var e = r.dom, t = r.getBody(), n = r.dom.getViewPort(r.getWin()), i = r.inline ? t.scrollTop : n.y, o = r.inline ? t.clientHeight : n.h;
        s(), u = e.add(r.getBody(), "div", {id: "mcepastebin", contentEditable: !0, "data-mce-bogus": "1", style: "position: absolute; top: " + (i + 20) + "px;" + "width: 10px; height: " + (o - 40) + "px; overflow: hidden; opacity: 0"}, m), e.setStyle(u, "left", "rtl" == e.getStyle(t, "direction", !0) ? 65535 : -65535), e.bind(u, "beforedeactivate focusin focusout", function(e) {
          e.stopPropagation()
        }), f = r.selection.getRng(), u.focus(), r.selection.select(u, !0)
      }
      function s() {
        u && (r.dom.unbind(u), r.dom.remove(u), f && r.selection.setRng(f)), h = !1, u = f = null
      }
      function l() {
        return u ? u.innerHTML : m
      }
      function c(e) {
        var t = {}, n = e.clipboardData || r.getDoc().dataTransfer;
        if (n && n.types) {
      ...
      var d = this, u, f, p = 0, m = "%MCEPASTEBIN%", h;
      r.on("keydown", function(n) {
        if (!n.isDefaultPrevented() && (t.metaKeyPressed(n) && 86 == n.keyCode || n.shiftKey && 45 == n.keyCode)) {
          if (h = n.shiftKey && 86 == n.keyCode, n.stopImmediatePropagation(), p = (new Date).getTime(), e.ie && h)
            return n.preventDefault(), r.fire("paste", {ieFake: !0}), void 0;
          a()
        }
      }), r.on("paste", function(t) {
        var f = c(t), g = (new Date).getTime() - p < 100, v = "text" == d.pasteFormat || h;
        g || t.preventDefault(), !e.ie || g && !t.ieFake || (a(), r.dom.bind(u, "paste", function(e) {
          e.stopPropagation()
        }), r.getDoc().execCommand("Paste", !1, null), f["text/html"] = l(), s()), setTimeout(function() {
          var e = l();
          return u && u.firstChild && "mcepastebin" === u.firstChild.id && (v = !0), s(), e != m && g || (e = f["text/html"] || f["text/plain"] || m, e != m) ? (v ? o(f["text/plain"] || n.innerText(e)) : i(e), void 0) : (g || r.windowManager.alert("Please use Ctrl+V/Cmd+V keyboard shortcuts to paste contents."), void 0)
        }, 0)
      }), d.pasteHtml = i, d.pasteText = o
    }
    ...
    function s(s) {
      ...
      s.on("BeforePastePreProcess", function(c) {
        ...
        if (p = l.paste_retain_style_properties, p && (m = e.makeMap(p)), l.paste_enable_default_filters !== !1 && a(c.content)) {
          ...
          h || (h = "@[style],-strong/b,-em/i,-span,-p,-ol,-ul,-li,-h1,-h2,-h3,-h4,-h5,-h6,-table,-tr,-td[colspan|rowspan],-th,-thead,-tfoot,-tbody,-a[!href],sub,sup,strike,br");
