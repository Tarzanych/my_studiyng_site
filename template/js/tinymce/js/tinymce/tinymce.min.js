  ...
  r(l, [], function() {
    ...
    return function(e, t) {
      ...
      return{toHex: function(e) {
          ...
          if (t) {
            for (t = t.replace(/[\u0000-\u001F]/g, ""), t = t.replace(/\\[\"\';:\uFEFF]/g, u).replace(/\"[^\"]+\"|\'[^\']+\'/g, function(e) {
              return e.replace(/[;:]/g, u)
            }); h = o.exec(t); ) {
              if (g = h[1].replace(a, "").toLowerCase(), v = h[2].replace(a, ""), g && v.length > 0) {
                if (!e.allow_script_urls && ("behavior" == g || /expression\s*\(/.test(v)))
                  continue;
                "font-weight" === g && "700" === v ? v = "bold" : ("color" === g || "background-color" === g) && (v = v.toLowerCase()), v = v.replace(r, n), v = v.replace(i, p), m[g] = y ? f(v, !0) : v
              }
              o.lastIndex = h.index + h[0].length
            }
    ...
    function t(n) {
      ...
      var M = this, D = n.doc, P = 0, O = 1, I = 2, F = !0, z = !1, W = "startOffset", V = "startContainer", U = "endContainer", q = "endOffset", j = e.extend, $ = n.nodeIndex;
      return j(M, {startContainer: D, startOffset: 0, endContainer: D, endOffset: 0, collapsed: F, commonAncestorContainer: D, START_TO_START: 0, START_TO_END: 1, END_TO_END: 2, END_TO_START: 3, setStart: i, setEnd: o, setStartBefore: a, setStartAfter: s, setEndBefore: l, setEndAfter: c, collapse: d, selectNode: u, selectNodeContents: f, compareBoundaryPoints: p, deleteContents: m, extractContents: h, cloneContents: g, insertNode: v, surroundContents: y, cloneRange: b, toStringIE: L}), M
    }
    ...
    return function(i, o) {
      ...
      i = i || {}, a.schema = o = o || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function(e) {
        ...
        function a(e, t, n, r, o) {
          ...
          W[t] && !i.allow_script_urls && /(java|vb)script:/i.test(decodeURIComponent(n.replace(l, ""))) || (p.map[t] = n, p.push({name: t, value: n}))
        }
        var s = this, l, c = 0, d, u, f = [], p, m, h, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, H, L, M, D, P, O, I = 0, F = t.decode, z, W = n.makeMap("src,href");
        for (M = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), D = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, b = o.getShortEndedElements(), L = i.self_closing_elements || o.getSelfClosingElements(), C = o.getBoolAttrs(), w = i.validate, y = i.remove_internals, z = i.fix_self_closing, P = o.getSpecialElements(); l = M.exec(e); ) {
          if (c < l.index && s.text(F(e.substr(c, l.index - c))), d = l[6])
            ...
            if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), x = d in b, z && L[d] && f.length > 0 && f[f.length - 1].name === d && r(d), !w || (_ = o.getElementRule(d))) {
              if (N = !0, w && (S = _.attributes, T = _.attributePatterns), (k = l[8]) ? (v = -1 !== k.indexOf("data-mce-type"), v && y && (N = !1), p = [], p.map = {}, k.replace(D, a)) : (p = [], p.map = {}), w && !v) {
                if (R = _.attributesRequired, A = _.attributesDefault, B = _.attributesForced, H = _.removeEmptyAttrs, H && !p.length && (N = !1), B)
                  for (m = B.length; m--; )
    ...
    return function(r, l) {
      ...
      r = r || {}, r.validate = "validate"in r ? r.validate : !0, r.root_name = r.root_name || "body", d.schema = l = l || new t, d.filterNode = function(e) {
        ...
        var v, y, b, C, x, w, _, N, E, k, S, T, R, A = [], B, H, L, M, D, P, O, I;
    ...
    return function(r, i) {
      ...
      function l(e, t, n) {
        ...
        r = b.getPos(e, p), T = r.x, R = r.y, f = e.getBoundingClientRect(), l = f.width || f.right - f.left, d = f.height || f.bottom - f.top, x != e && (h(), x = e, M = D = 0), u = i.fire("ObjectSelected", {target: e}), o(e) && !u.isDefaultPrevented() ? C(_, function(e, r) {
          function o(t) {
            L = !0, k = t.screenX, S = t.screenY, A = x.clientWidth, B = x.clientHeight, H = B / A, N = e, w = x.cloneNode(!0), b.addClass(w, "mce-clonedresizable"), w.contentEditable = !1, w.unSelectabe = !0, b.setStyles(w, {left: T, top: R, margin: 0}), w.removeAttribute("data-mce-selected"), i.getBody().appendChild(w), b.bind(P, "mousemove", a), b.bind(P, "mouseup", s), O != P && (b.bind(O, "mousemove", a), b.bind(O, "mouseup", s))
          }
          var c, u;
      ...
      var b = i.dom, C = t.each, x, w, _, N, E, k, S, T, R, A, B, H, L, M, D, P = i.getDoc(), O = document, I = n.ie && n.ie < 11;
    ...
    return a.prototype = {setCursorLocation: function(e, t) {
        ...
        function t(t) {
          ...
          function l(t, n) {
            ...
            for (n = n || c, r = new e(n, f.getParent(n.parentNode, f.isBlock) || p); m = r[t ? "prev" : "next"](); ) {
              if (3 === m.nodeType && m.nodeValue.length > 0)
                return c = m, d = t ? m.nodeValue.length : 0, i = !0, void 0;
          ...
          var c, d, u, f = n.dom, p = f.getRoot(), m, h, g;
          if (c = r[(t ? "start" : "end") + "Container"], d = r[(t ? "start" : "end") + "Offset"], h = f.schema.getNonEmptyElements(), 9 === c.nodeType && (c = f.getRoot(), d = 0), c === p) {
            if (t && (m = c.childNodes[d > 0 ? d - 1 : 0], m && (g = m.nodeName.toLowerCase(), h[m.nodeName] || "TABLE" == m.nodeName)))
              return;
    ...
    return function(r) {
      ...
      function p(t, n, o) {
        ...
        if (h)
          if (o)
            o.nodeType ? (y = I.createRng(), y.setStartBefore(o), y.setEndAfter(o), u(T(y, m), null, !0)) : u(o, null, !0);
      ...
      function D(t, n, o) {
        ...
        function h() {
          ...
          if (u)
            if (l)
              s = F.getBookmark(), e.collapse(!0), e = T(e, c(n), !0), e = z.split(e), m(n, o, e), F.moveToBookmark(s);
            else {
              for (h = a(), d = h, p = f.length - 1; p >= 0; p--)
    ...
    return r = new RegExp(["<span[^>]+data-mce-bogus[^>]+>[\u200b\ufeff]+<\\/span>", "<div[^>]+data-mce-bogus[^>]+><\\/div>", '\\s?data-mce-selected="[^"]+"'].join("|"), "gi"), function(t) {
      ...
      return t.on("init", function() {
        ...
        e.isDefaultPrevented() || t.nodeChanged()
          ...
          if (e = e || {}, e.content = i(), u || t.fire("BeforeAddUndo", {level: e}).isDefaultPrevented())
            return null;
    ...
    return function(t) {
      function r(r) {
        ...
        function p(t) {
          ...
          var r, a, s, l = t, d;
          if ("LI" == t.nodeName) {
            var u = n(t.firstChild);
            u && /^(UL|OL)$/.test(u.nodeName) && t.insertBefore(i.doc.createTextNode("\xa0"), t.firstChild)
          }
          if (s = i.createRng(), t.hasChildNodes()) {
            for (r = new e(t, t); a = r.current(); ) {
              if (3 == a.nodeType) {
                s.setStart(a, 0), s.setEnd(a, 0);
                break
              }
              if (c[a.nodeName.toLowerCase()]) {
                s.setStartBefore(a), s.setEndBefore(a);
                break
              }
              l = a, a = r.next()
            }
            ...
            "BR" == t.nodeName ? t.nextSibling && i.isBlock(t.nextSibling) ? ((!A || 9 > A) && (d = i.create("br"), t.parentNode.insertBefore(d, t)), s.setStartBefore(t), s.setEndBefore(t)) : (s.setStartAfter(t), s.setEndAfter(t)) : (s.setStart(t, 0), s.setEnd(t, 0));
          o.setRng(s), i.remove(d), o.scrollIntoView(t)
        }
        function m(e) {
        ...
        function h(e) {
          var t = S, r, o, s;
          if (e || "TABLE" == D ? (r = i.create(e || O), m(r)) : r = R.cloneNode(!1), s = r, a.keep_styles !== !1)
            do
        ...
        function g(t) {
          var n, r, i;
          if (3 == S.nodeType && (t ? T > 0 : T < S.nodeValue.length))
            return!1;
          if (S.parentNode == R && I && !t)
            return!0;
          if (t && 1 == S.nodeType && S == R.firstChild)
            return!0;
          if ("TABLE" === S.nodeName || S.previousSibling && "TABLE" == S.previousSibling.nodeName)
            return I && !t || !I && t;
        ...
        function y() {
          ...
          /^(OL|UL|LI)$/.test(n) && (O = "LI"), H = O ? h(O) : i.create("BR"), e(!0) && e() ? "LI" == n ? i.insertAfter(H, t()) : i.replace(H, M) : e(!0) ? "LI" == n ? (i.insertAfter(H, t()), H.appendChild(i.doc.createTextNode(" ")), H.appendChild(M)) : M.parentNode.insertBefore(H, M) : e() ? (i.insertAfter(H, t()), u(H)) : (M = t(), E = N.cloneRange(), E.setStartAfter(R), E.setEndAfter(M), L = E.extractContents(), "LI" == O && "LI" == L.firstChild.nodeName ? (H = L.firstChild, i.insertAfter(L, M)) : (i.insertAfter(L, M), i.insertAfter(H, M))), i.remove(R), p(H), s.add()
        }
        function b() {
        ...
        var N = o.getRng(!0), E, k, S, T, R, A, B, H, L, M, D, P, O, I;
        if (!N.collapsed)
        ...
        if (!r.isDefaultPrevented() && (S = N.startContainer, T = N.startOffset, O = (a.force_p_newlines ? "p" : "") || a.forced_root_block, O = O ? O.toUpperCase() : "", A = i.doc.documentMode, B = r.shiftKey, 1 == S.nodeType && S.hasChildNodes() && (I = T > S.childNodes.length - 1, S = S.childNodes[Math.min(T, S.childNodes.length - 1)] || S, T = I && 3 == S.nodeType ? S.nodeValue.length : 0), k = w(S))) {
          if (s.beforeChange(), !i.isBlock(k) && k != i.getRoot())
            return(!O || B) && C(), void 0;
          if ((O && !B || !O && B) && (S = v(S, T)), R = i.getParent(S, i.isBlock), M = R ? i.getParent(R.parentNode, i.isBlock) : null, D = R ? R.nodeName.toUpperCase() : "", P = M ? M.nodeName.toUpperCase() : "", "LI" != P || r.ctrlKey || (R = M, D = P), "LI" == D) {
            if (!O && B)
              return C(), void 0;
            if (i.isEmpty(R))
              return y(), void 0
          ...
          if ("PRE" == D && a.br_in_pre !== !1) {
            if (!B)
              return C(), void 0
          } else if (!O && !B && "LI" != D || O && B)
            return C(), void 0;
          O && R === t.getBody() || (O = O || "P", g() ? (H = /^(H[1-6]|PRE|FIGURE)$/.test(D) && "HGROUP" != P ? h(O) : h(), a.end_container_on_empty_block && d(M) && i.isEmpty(R) ? H = i.split(M, R) : i.insertAfter(H, R), p(H)) : g(!0) ? (H = R.parentNode.insertBefore(h(), R), u(H), p(R)) : (E = N.cloneRange(), E.setEndAfter(R), L = E.extractContents(), x(L), H = L.firstChild, i.insertAfter(L, R), f(H), _(R), p(H)), i.setAttrib(H, "id", ""), t.fire("NewBlock", {newBlock: H}), s.add())
        }
      }
    ...
    return function(n) {
      ...
      o(this, {execCommand: r, queryCommandState: p, queryCommandValue: m, addCommands: h}), h({"mceResetDesignMode,mceBeginUndoLevel": function() {
          ...
          /^ | $/.test(i) && (i = o(i)), a = n.parser, s = new e({}, n.schema), v = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;</span>', f = {content: i, format: "html", selection: !0}, n.fire("BeforeSetContent", f), i = f.content, -1 == i.indexOf("{$caret}") && (i += "{$caret}"), i = i.replace(/\{\$caret\}/, v);
          var y = n.getBody();
          x.isBlock(y.firstChild) && x.isEmpty(y.firstChild) && (y.firstChild.appendChild(x.doc.createTextNode("\xa0")), w.select(y.firstChild, !0), x.remove(y.firstChild.lastChild)), w.isCollapsed() || n.getDoc().execCommand("Delete", !1, null), l = w.getNode();
          var b = {context: l.nodeName.toLowerCase()};
          if (u = a.parse(i, b), h = u.lastChild, "mce_marker" == h.attr("id"))
            for (p = h, h = h.prev; h; h = h.walk(!0))
              if (3 == h.type || !x.isBlock(h.name)) {
                h.parent.insert(p, h, "br" === h.name);
                break
              }
          if (b.invalid) {
            for (w.setContent(v), l = w.getNode(), c = n.getBody(), 9 == l.nodeType?l = h = c:h = l; h !== c; )
              l = h, h = h.parentNode;
            ...
            i = s.serialize(u), h = l.firstChild, g = l.lastChild, !h || h === g && "BR" === h.nodeName ? x.setHTML(l, i) : w.setContent(i);
          p = x.get("mce_marker"), w.scrollIntoView(p), m = x.createRng(), h = p.previousSibling, h && 3 == h.nodeType ? (m.setStart(h, h.nodeValue.length), d || (g = p.nextSibling, g && 3 == g.nodeType && (h.appendData(g.data), g.parentNode.removeChild(g)))) : (m.setStartBefore(p), m.setEndBefore(p)), x.remove(p), w.setRng(m), n.fire("SetContent", f), n.addVisual()
    ...
    return function(a) {
      ...
      function d() {
        function t(e) {
          ...
          if (n.collapsed || (e = !0), l = n[(e ? "start" : "end") + "Container"], c = n[(e ? "start" : "end") + "Offset"], 3 == l.nodeType && (r = z.getParent(n.startContainer, z.isBlock), e && (r = z.getNext(r, z.isBlock)), !r || !t() && n.collapsed || (i = z.create("em", {id: "__mceDel"}), O(o.grep(r.childNodes), function(e) {
            i.appendChild(e)
            ...
            for (s = W.getBookmark(); d = z.get("__mceDel"); )
              z.remove(d, !0);
            W.moveToBookmark(s)
          }
        }
      ...
      function u() {
        ...
        a.on("keydown", function(e) {
          var n = e.keyCode, r;
          if (!c(e) && (n == F || n == I)) {
            if (r = a.selection.isCollapsed(), r && !z.isEmpty(a.getBody()))
              return;
            if ($ && !r)
              return;
      ...
      function m() {
        a.on("keydown", function(e) {
          if (!c(e) && e.keyCode === I && W.isCollapsed() && 0 === W.getRng(!0).startOffset) {
            ...
            if ("HR" == t.nodeName)
              return z.remove(t), e.preventDefault(), void 0;
        ...
        a.on("keydown", function(t) {
          ...
          if (n = t.keyCode == F, !c(t) && (n || t.keyCode == I) && !e.modifierPressed(t) && (r = W.getRng(), i = r.startContainer, o = r.startOffset, d = r.collapsed, 3 == i.nodeType && i.nodeValue.length > 0 && (0 === o && !d || d && o === (n ? 0 : 1)))) {
            if (l = i.previousSibling, l && "IMG" == l.nodeName)
              return;
            u = a.schema.getNonEmptyElements(), t.preventDefault(), s = z.create("br", {id: "__tmp"}), i.parentNode.insertBefore(s, i), a.getDoc().execCommand(n ? "ForwardDelete" : "Delete", !1, null), i = W.getRng().startContainer, l = i.previousSibling, l && 1 == l.nodeType && !z.isBlock(l) && z.isEmpty(l) && !u[l.nodeName.toLowerCase()] && z.remove(l), z.remove("__tmp")
          }
        })
      }
      function N() {
    ...
    var E = e.DOM, k = n.ThemeManager, S = n.PluginManager, T = C.extend, R = C.each, A = C.explode, B = C.inArray, H = C.trim, L = C.resolve, M = m.Event, D = b.gecko, P = b.ie;
    return N.prototype = {render: function() {
        ...
        if (document.domain != location.hostname && (c = g), s = E.add(l.iframeContainer, "iframe", {id: t.id + "_ifr", src: c || 'javascript:""', frameBorder: "0", allowTransparency: "true", title: t.editorManager.translate("Rich Text Area. Press ALT-F9 for menu. Press ALT-F10 for toolbar. Press ALT-0 for help"), style: {width: "100%", height: o, display: "block"}}), P)
          try {
            t.getDoc()
          } catch (v) {
            s.src = c = g
        ...
        if (n)
          return t.callbackLookup && (r = t.callbackLookup[e]) && (n = r.func, r = r.scope), "string" == typeof n && (r = n.replace(/\.\w+$/, ""), r = r ? L(r) : 0, n = L(n), t.callbackLookup = t.callbackLookup || {}, t.callbackLookup[e] = {func: n, scope: r}), n.apply(r || t, Array.prototype.slice.call(arguments, 1))
    ...
    function n(r) {
      ...
      function s(s) {
        ...
        c.on("init", function() {
          ...
          c.selection.lastFocusBookmark && (c.selection.setRng(a(c, c.selection.lastFocusBookmark)), c.selection.lastFocusBookmark = null), e != c && (e && e.fire("blur", {focusedEditor: c}), r.activeEditor = c, c.fire("focus", {blurredEditor: e}), c.focus(!1), r.focusedEditor = c), d = null
    ...
    var c = n.DOM, d = o.explode, u = o.each, f = o.extend, p = 0, m, h = {majorVersion: "4", minorVersion: "0.10", releaseDate: "2013-10-28", editors: [], i18n: s, activeEditor: null, setup: function() {
        var e = this, t, n, i = "", o;
    ...
    return e.extend({recalc: function(e) {
        var t, n, r, i, o, a, s, l, c, d, u, f, p, m, h, g, v = [], y, b, C, x, w, _, N, E, k, S, T, R, A, B, H, L, M, D, P, O, I, F, z, W, V = Math.max, U = Math.min;
        for (r = e.items().filter(":visible"), i = e.layoutRect(), o = e._paddingBox, a = e.settings, f = e.isRtl()?a.direction || "row-reversed":a.direction, s = a.align, l = e.isRtl()?a.pack || "end":a.pack, c = a.spacing || 0, ("row-reversed" == f || "column-reverse" == f) && (r = r.set(r.toArray().reverse()), f = f.split("-")[0]), "column" == f?(k = "y", N = "h", E = "minH", S = "maxH", R = "innerH", T = "top", A = "bottom", B = "deltaH", H = "contentH", I = "left", D = "w", L = "x", M = "innerW", P = "minW", O = "maxW", F = "right", z = "deltaW", W = "contentW"):(k = "x", N = "w", E = "minW", S = "maxW", R = "innerW", T = "left", A = "right", B = "deltaW", H = "contentW", I = "top", D = "h", L = "y", M = "innerH", P = "minH", O = "maxH", F = "bottom", z = "deltaH", W = "contentH"), u = i[R] - o[T] - o[T], _ = d = 0, t = 0, n = r.length; n > t; t++)
          p = r[t], m = p.layoutRect(), h = p.settings, g = h.flex, u -= n - 1 > t ? c : 0, g > 0 && (d += g, m[S] && v.push(p), m.flex = g), u -= m[E], y = o[I] + m[P] + o[F], y > _ && (_ = y);
        if (x = {}, x[E] = 0 > u ? i[E] - u + i[B] : i[R] - u + i[B], x[P] = _ + i[z], x[H] = i[R] - u, x[W] = _, x.minW = U(x.minW, i.maxW), x.minH = U(x.minH, i.maxH), x.minW = V(x.minW, i.startMinWidth), x.minH = V(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
          for (C = u / d, t = 0, n = v.length; n > t; t++)
            p = v[t], m = p.layoutRect(), b = m[S], y = m[E] + Math.ceil(m.flex * C), y > b ? (u -= m[S] - m[E], d -= m.flex, m.flex = 0, m.maxFlexSize = b) : m.maxFlexSize = 0;
          for (C = u / d, w = o[T], x = {}, 0 === d && ("end" == l?w = u + o[T]:"center" == l?(w = Math.round(i[R] / 2 - (i[R] - u) / 2) + o[T], 0 > w && (w = o[T])):"justify" == l && (w = o[T], c = Math.floor(u / (r.length - 1)))), x[L] = o[I], t = 0, n = r.length; n > t; t++)
            p = r[t], m = p.layoutRect(), y = m.maxFlexSize || m[E], "center" === s ? x[L] = Math.round(i[M] / 2 - m[D] / 2) : "stretch" === s ? (x[D] = V(m[P] || 0, i[M] - o[I] - o[F]), x[L] = o[I]) : "end" === s && (x[L] = i[M] - m[D] - o.top), m.flex > 0 && (y += Math.ceil(m.flex * C)), x[N] = y, x[k] = w, p.layoutRect(x), p.recalc && p.recalc(), w += y + c
    ...
    return e.extend({recalc: function(e) {
        ...
        if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
          ...
          var D = A / L;
          for (u = 0; r > u; u++)
            N[u] += M ? Math.ceil(M[u] * D) : D;
          for (m = g.top, f = 0; n > f; f++) {
            for (p = g.left, s = E[f] + H, u = 0; r > u && (d = i[f * r + u], d); u++)
              h = d.settings, c = d.layoutRect(), a = Math.max(N[u], c.startMinWidth), T = R = 0, c.x = p, c.y = m, v = h.alignH || (C ? C[u] || C[0] : null), "center" == v ? c.x = p + a / 2 - c.w / 2 : "right" == v ? c.x = p + a - c.w : "stretch" == v && (c.w = a), v = h.alignV || (x ? x[u] || x[0] : null), "center" == v ? c.y = m + s / 2 - c.h / 2 : "bottom" == v ? c.y = m + s - c.h : "stretch" == v && (c.h = s), d.layoutRect(c), p += a + y, d.recalc && d.recalc();
            m += s + b
          }
    ...
    return e.extend({Defaults: {classes: "widget btn splitbtn", role: "splitbutton"}, repaint: function() {
        ...
        return e.on("click", function(e) {
          ...
          if (e.control == this)
            for (; n; ) {
              if ("BUTTON" == n.nodeName && -1 == n.className.indexOf("open"))
                return e.stopImmediatePropagation(), t.call(this, e), void 0;
              n = n.parentNode
            }
        }), delete e.settings.onclick, e._super()
      }})
