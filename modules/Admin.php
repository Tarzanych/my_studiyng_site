				...
				if (isset($_REQUEST['Action']) && $_REQUEST['Action']!="") {
					switch ($_REQUEST['Action']) {
						...
						case "checkCreateCatForm":
							...
							if ($tCount > 0) $data['errors'] .= "Another category with such title exists<br />";
							if ($pCheck == 0 && $parent!=0) $data['errors'] .= "Parent id error<br />";
							if ($uCount > 0) $data['errors'] .= "Another category with such URL exists<br />";
							if (mb_strlen(trim($_POST['title'])) == 0) $data['errors'] .= "Please enter category title<br />";
							if (mb_strlen(trim($_POST['url'])) == 0) $data['errors'] .= "Please enter category URL<br />";
							if (mb_strlen(trim($data['errors'])) == 0) $data['success'] = true;
							echo json_encode($data);
							exit;
						break;
						...
						case "checkEditCatForm":
							...
							if ($id == 0 || GetOne("select count(`id`) from `category` where `id`='{$id}'")==0) $data['errors'] .= "Category id error<br />";
							if ($pCheck == 0 && $parent!=0) $data['errors'] .= "Pareny id error<br />";
							if ($tCount > 0) $data['errors'] .= "Another category with such title exists<br />";
							if ($uCount > 0) $data['errors'] .= "Another category with such URL exists<br />";
							if (isset($_POST['title']) && mb_strlen(trim($_POST['title'])) == 0) $data['errors'] .= "Please enter category title<br />";
							if (isset($_POST['url']) && mb_strlen(trim($_POST['url'])) == 0) $data['errors'] .= "Please enter category URL<br />";
							if (mb_strlen($data['errors']) == 0) $data['success'] = true;
							echo json_encode($data);
							exit;
						break;
